    ...
    newFilm(film, categories, callback) {
        this.pool.getConnection((err, connection) => {
            if(err){
                ...
                connection.query("INSERT INTO FILMS (title, engtitle, year, date, color, animationtechnique, originalv, genre, duration, country, screen, shootingplace, catalogue, sinopsis, eng_sinopsis, esp_sinopsis, materialslink, link, originalvimeo, englishvimeo, frenchvimeo, italianvimeo, spavimeo, trailer, trailereng, director, script, photography, artistic, soundtrack, montage, producer, animation, sound, interpreter, copiesheader, copiesstreet, copiescp, NIF, copiestel, copiescity, copiesprovince, copiescountry, addcatalogue, picture) VALUES ?",
                [film],
                (err, result) => {
                    if (err) { callback(err);}
                    else {
