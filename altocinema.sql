...
CREATE TABLE PRIZES (
    ...
    amount FLOAT,
    CONSTRAINT FK_film_prize FOREIGN KEY (film) REFERENCES FESTIVALS (id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_festival_prize FOREIGN KEY (festival) REFERENCES FESTIVALS (id) ON DELETE CASCADE ON UPDATE CASCADE,
    primary key(id)
);
...
CREATE TABLE CONNECTFESTIVALCATEGORIES ( 
 ...
 CREATE TABLE PREINSCR (
    festival_id INT NOT NULL,
    film_id INT NOT NULL,
    preinscripted BOOLEAN DEFAULT FALSE,
